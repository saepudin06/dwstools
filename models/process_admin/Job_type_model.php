...
/*
  classname :  Job_type_model
  Date      : 29-11-2017 02:10:48
 
 */
class Job_type_model extends Abstract_model {

    public $table           = 'p_job_type';
    public $pkey            = 'p_job_type_id';
    public $alias           = '';

    public $fields          = array(
								'p_job_type_id'=> array (   'pkey' => true,'type' => 'int' , 'nullable' => false , 'unique' => false , 'display' =>  'P Job Type Id' ),
    ...
    public $selectClause    = "*";
    public $fromClause      = "vw_md_job_type";
...
/* End of file Job_type_model.php */