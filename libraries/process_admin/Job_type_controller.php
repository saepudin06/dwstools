...
class Job_type_controller {
    ...
    function read_module() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('process_admin/job_type_model');
            $table = $ci->job_type_model;
            $table->fromClause = "vw_modules";
    ...
    function read() {
        ...
        try {
            ...
            // Filter Table
            $req_param['where'] = array("module_id = " . $module_id);
...
/* End of file Job_type_controller.php */