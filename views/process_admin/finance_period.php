    ...
    function set_grid_list() {
        ...
        if (is_set_grid != 'true'){
            ...
            jQuery(grid_selector).jqGrid({
                ...
                postData: { p_year_period_id: get_selected_grid('#grid-table', 'p_year_period_id') },
                datatype: "json",
                mtype: "POST",
                colModel: [
                ...
                },
                {
                    ...
                    editData: {
                        p_year_period_id: function() {
                            return get_selected_grid('#grid-table', 'p_year_period_id');
                        }
                    },
                    serializeEditData: serializeJSON,
                    //new record form
            ...
            reload_grid(grid_selector, { p_year_period_id: get_selected_grid('#grid-table', 'p_year_period_id') });
        }
    }
