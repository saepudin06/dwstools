...
/**
* Json library
* @class Closing_period_process_controller
...
class Closing_period_process_controller {
    ...
    function submit_job() {
        ...
        try {
            $sql = "select f_submit_job ('CLOSINGPERIOD', ".$data_control_id.", '".$userdata['user_name']."') as hasil";
...
/* End of file Closing_period_process_controller.php */