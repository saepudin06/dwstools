...
/**
* Json library
* @class Param_dws_p_schembis_type_controller
...
class Param_dws_p_schembis_type_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_p_schembis_type');
            $table = $ci->param_dws_p_schembis_type;
...
/* End of file Param_dws_p_schembis_type_controller.php */