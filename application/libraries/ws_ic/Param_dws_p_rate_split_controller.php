...
/**
* Json library
* @class Param_dws_p_rate_split_controller
...
class Param_dws_p_rate_split_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_p_rate_split');
            $table = $ci->param_dws_p_rate_split;
    ...
    function read_lov_dws_p_schembis() {
        ...
        try {
            ...
            $ci->load->model('ws_ic/param_dws_p_rate_split');
            $table = $ci->param_dws_p_rate_split;
            $table->fromClause = "ic_dws.dws_p_schembis";
    ...
    function read_lov_p_reference_list() {

        $page = getVarClean('page','int',1);
        $limit = getVarClean('rows','int',5);
        $sidx = getVarClean('sidx','str','updated_date');
        $sord = getVarClean('sord','str','desc');
        ...
        try {
            ...
            $ci->load->model('ws_ic/param_dws_p_rate_split');
            $table = $ci->param_dws_p_rate_split;
            $table->fromClause = "public.p_reference_list";
...
/* End of file Param_dws_p_rate_split_controller.php */