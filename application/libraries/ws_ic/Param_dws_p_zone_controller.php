...
/**
* Json library
* @class Param_dws_p_zone_controller
...
class Param_dws_p_zone_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_p_zone');
            $table = $ci->param_dws_p_zone;
    ...
    function read_lov_sap_zone() {

        $page = getVarClean('page','int',1);
        $limit = getVarClean('rows','int',5);
        $sidx = getVarClean('sidx','str','p_sap_zone_id');
        $sord = getVarClean('sord','str','desc');
        ...
        try {
            ...
            $ci->load->model('ws_ic/param_dws_p_zone');
            $table = $ci->param_dws_p_zone;
            $table->fromClause = "ic_dws.dws_p_sap_zone";
...
/* End of file Param_dws_p_zone_controller.php */