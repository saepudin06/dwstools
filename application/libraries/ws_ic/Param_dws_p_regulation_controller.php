...
/**
* Json library
* @class Param_dws_p_regulation_controller
...
class Param_dws_p_regulation_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_p_regulation');
            $table = $ci->param_dws_p_regulation;
...
/* End of file Param_dws_p_regulation_controller.php */