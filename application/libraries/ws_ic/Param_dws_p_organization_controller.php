...
/**
* Json library
* @class Param_dws_p_organization_controller
...
class Param_dws_p_organization_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_p_organization');
            $table = $ci->param_dws_p_organization;
            $p_company_id = getVarClean('p_company_id', 'str', '');
...
/* End of file Param_dws_p_organization_controller.php */