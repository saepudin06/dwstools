...
/**
* Json library
* @class Param_dws_p_tariff_used_controller
...
class Param_dws_p_tariff_used_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_p_tariff_used');
            $table = $ci->param_dws_p_tariff_used;
    ...
    function read_lov_dws_p_organization() {

        $page = getVarClean('page','int',1);
        $limit = getVarClean('rows','int',5);
        $sidx = getVarClean('sidx','str','p_organization_id');
        $sord = getVarClean('sord','str','desc');
        ...
        try {
            ...
            $ci->load->model('ws_ic/param_dws_p_tariff_used');
            $table = $ci->param_dws_p_tariff_used;
            $table->fromClause = "ic_dws.dws_p_organization";
    ...
    function read_lov_dws_p_zone() {

        $page = getVarClean('page','int',1);
        $limit = getVarClean('rows','int',5);
        $sidx = getVarClean('sidx','str','p_zone_id');
        $sord = getVarClean('sord','str','desc');
        ...
        try {
            ...
            $ci->load->model('ws_ic/param_dws_p_tariff_used');
            $table = $ci->param_dws_p_tariff_used;
            $table->fromClause = "ic_dws.dws_p_zone";
...
/* End of file Param_dws_p_tariff_used_controller.php */