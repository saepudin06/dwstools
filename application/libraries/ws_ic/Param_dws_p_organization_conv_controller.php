...
/**
* Json library
* @class Param_dws_p_organization_conv_controller
...
class Param_dws_p_organization_conv_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_p_organization_conv');
            $table = $ci->param_dws_p_organization_conv;
...
/* End of file Param_dws_p_organization_conv_controller.php */