...
*/
class Process_validation_batch_rate_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/process_validation_batch_rate');
            $table = $ci->process_validation_batch_rate;
    ...
    function html_select_options_reference_type() {
        try {
            ...
            $res = $table->db->where('p_reference_type_id', 28)->get('p_reference_list')->result_array();
...
/* End of file process_validation_batch_rate_controller.php */