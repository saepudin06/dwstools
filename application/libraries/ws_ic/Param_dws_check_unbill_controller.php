...
/**
* Json library
* @class Param_dws_check_unbill_controller
...
class Param_dws_check_unbill_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_check_unbill');
            $table = $ci->param_dws_check_unbill;
...
/* End of file Param_dws_check_unbill_controller.php */