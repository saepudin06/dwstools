...
/**
* Json library
* @class Param_dws_check_unrated_controller
...
class Param_dws_check_unrated_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/param_dws_check_unrated');
            $table = $ci->param_dws_check_unrated;
...
/* End of file Param_dws_check_unrated_controller.php */