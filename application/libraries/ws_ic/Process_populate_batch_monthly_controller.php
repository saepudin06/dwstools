...
*/
class Process_populate_batch_monthly_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_ic/process_populate_batch_monthly');
            $table = $ci->process_populate_batch_monthly;
    ...
    function html_select_options_reference_type() {
        try {
            ...
            $res = $table->db->where('p_reference_type_id', 1)->get('p_reference_list')->result_array();
...
/* End of file process_populate_batch_monthly_controller.php */