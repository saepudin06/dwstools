...
/**
* Json library
* @class Param_bill_billcomponent_controller
    ...
    function read() {
       ...
       // $idreferencetype = getVarClean('p_reference_type_id','int',0);
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_idd_olo/param_bill_billcomponent');
            $table = $ci->param_bill_billcomponent;
...
/* End of file Param_bill_billcomponent_controller.php */