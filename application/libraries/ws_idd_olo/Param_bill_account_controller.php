...
/**
* Json library
* @class Param_bill_account_controller
...
class Param_bill_account_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','p_account_id');
       ...
       // $idreferencetype = getVarClean('p_reference_type_id','int',0);
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_idd_olo/param_bill_account');
            $table = $ci->param_bill_account;
...
/* End of file Param_bill_account_controller.php */