...
/**
* Json library
* @class Param_zone_coverage_area_controller
...
class Param_zone_coverage_area_controller {
    ...
    function read() {
        ...
        $sidx = getVarClean('sidx','str','p_coverage_area_id');
       ...
       // $idreferencetype = getVarClean('p_reference_type_id','int',0);
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_idd_olo/param_zone_coverage_area');
            $table = $ci->param_zone_coverage_area;
...
/* End of file Param_zone_coverage_area_controller.php */