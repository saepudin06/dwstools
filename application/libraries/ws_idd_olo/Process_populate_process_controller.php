...
/**
* Json library
* @class Process_populate_process_controller
...
class Process_populate_process_controller {
    ...
    function read() {
        ...
        try {
            ...
            $ci = & get_instance();
            $ci->load->model('ws_idd_olo/process_populate_process');
            $table = $ci->process_populate_process;
...
/* End of file Process_populate_process_controller.php */