...
<script>
    $(function() {
        ...
        $('#tree-job').on('select', function (event) {
            var item = $('#tree-job').jqxTree('getItem', event.args.element);
    ...
    function set_tree_job() {
        var source =
        {
            ...
            id: 'id',
            url: '<?php echo WS_JQGRID."process_admin.daftar_job_controller/tree_job?p_job_type_id=".$this->input->post("p_job_type_id"); ?>',
            async: false
        };
    ...
    function set_grid(){
        ...
        jQuery(grid_selector).jqGrid({
            ...
            datatype: "json",
            mtype: "POST",
            postData: { module_id: "<?php echo $this->input->post('module_id'); ?>", p_job_type_id: "<?php echo $this->input->post('p_job_type_id'); ?>", parent_id: parent_id },
            colModel: [
