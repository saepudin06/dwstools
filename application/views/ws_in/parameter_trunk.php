...
<script>
    ...
    var pager_selector = "#grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            url: '<?php echo WS_JQGRID."ws_in.parameter_trunk_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
            ...
            onSelectRow: function (rowid) {
                /*do something when selected*/
                  ...
                  jQuery("#grid-table-group").jqGrid('setGridParam', {
                        url: '<?php echo WS_JQGRID."ws_in.parameter_trunk_controller/readGroup"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."ws_in.parameter_trunk_controller/read"; ?>',
            caption: "Trunk"
    ...
    var pager_selector = "#grid-pager-group";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {label: 'Access Code', name: 'p_access_code', width: 130, align: 'left'},
                {label: 'Is International', name: 'is_international', width: 130, align: 'left'},
                {label: 'Is Interlink', name: 'is_interlink', width: 130, align: 'left'},
            ...
            //memanggil controller jqgrid yang ada di controller crud
            editurl: '<?php echo WS_JQGRID."ws_in.parameter_trunk_controller/readGroup"; ?>',
            caption: "Trunk Group"
