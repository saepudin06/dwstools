...
<script>
    $("#tab-1").on("click", function(event) {
        ...
        loadContentWithParams("ws_in.param_bill_year_period", {
...
<script>
    ...
    function set_grid_detail(){
        ...
        if (is_set_grid != 'true'){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_in.param_bill_day_category_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                ...
                //memanggil controller jqgrid yang ada di controller crud
                editurl: '<?php echo WS_JQGRID."ws_in.param_bill_day_category_controller/crud"; ?>',
    ...
    function generate_day_category() {
        Swal.fire({
            ...
            if (result.value) {
                var var_url = '<?php echo WS_JQGRID."ws_in.param_bill_day_category_controller/generate_day_category"; ?>';
                $.ajax({
                  url: var_url ,
                  type: "POST",
                  dataType: "json",
