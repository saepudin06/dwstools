...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item active">Reference Type</li>
</ol>
<!-- end breadcrumb -->
<div class="panel">
    <div class="panel-hdr">
...
<script>
    ...
    function set_grid(){
        ...
        if (is_set_grid != 'true'){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_idd.referencetype_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                colModel: [
                    ...
                    {label: 'Reference Name', name: 'reference_name', width: 150, align: 'left', editable: true,
                          editoptions:{
                              size: 30,
                              maxlength:64
                         }, editrules: {required: true}
                ...
                editurl: '<?php echo WS_JQGRID."ws_idd.referencetype_controller/crud"; ?>',
    ...
    function set_grid_list() {
        ...
        if (is_set_grid != 'true'){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_idd.referencelist_controller/crud";?>',
                postData: { p_reference_type_id: get_selected_grid('#grid-table', 'p_reference_type_id') },
                datatype: "json",
                mtype: "POST",
                colModel: [
                    ...
                    {label: 'Reference Type Id', name: 'p_reference_type_id', width: 150, align: 'left', editable: true, hidden:true,
                          editoptions:{
                                 size: 30,
                                 maxlength:22
                         }, editrules: {required: false}
                ...
                //memanggil controller jqgrid yang ada di controller crud
                editurl: '<?php echo WS_JQGRID."ws_idd.referencelist_controller/crud";?>',
                ...
                },
                {
                    ...
                    editData: {
                        p_reference_type_id: function() {
                            return get_selected_grid('#grid-table', 'p_reference_type_id');
                        }
                    },
                    serializeEditData: serializeJSON,
                    //new record form
            ...
            reload_grid(grid_selector, { p_reference_type_id: get_selected_grid('#grid-table', 'p_reference_type_id') });
        }
    }
