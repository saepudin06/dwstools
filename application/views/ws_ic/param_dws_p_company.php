...
<script>
    ...
    function set_grid(){
        ...
        if (is_set_grid != 'true'){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_ic.param_dws_p_company_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                postData: postData,
                colModel: [
                    {label: 'P Company ID', name: 'p_company_id', key: true, align: 'center', width: 150, hidden: true, editable: true },
                ...
                editurl: '<?php echo WS_JQGRID."ws_ic.param_dws_p_company_controller/crud"; ?>',
                caption: "Company"
    ...
    function set_grid_detail(){
        ...
        var postData = {p_company_id: get_selected_grid("#grid-table", 'p_company_id')};

        if (is_set_grid != 'true'){
            $('#is_set_grid_detail').val('true');
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_ic.param_dws_p_organization_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                postData: postData,
                colModel: [
                    {label: 'P organization ID', name: 'p_organization_id', key: true, align: 'center', width: 150, hidden: true, editable: true },
