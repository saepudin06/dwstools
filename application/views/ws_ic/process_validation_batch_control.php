...
<ol class="breadcrumb page-breadcrumb">
    ...
    <li class="breadcrumb-item">Telkom WS - Incoming</li>
...
<script>
    $("#tab-2").on("click", function(event) {
        ...
        loadContentWithParams("ws_ic.process_validation_process", {
    ...
    function set_grid() {
        ...
        if (is_set_grid.val() == "false"){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_ic.process_validation_batch_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                colModel: [
                    ...
                    {label: 'Code', name: 'input_data_class_id', width: 100, align: "center", editable: true, hidden: true,
                        ...
                        edittype: 'select',
                        editoptions: {
                            dataUrl: "<?php echo WS_JQGRID.'ws_ic.process_validation_batch_controller/html_select_options_reference_type'; ?>",
                    ...
                    {label: 'Finance Periode', name: 'p_finance_period_id', width: 100, align: "center", editable: true, hidden: true,
                        ...
                        edittype: 'select',
                        editoptions: {
                            dataUrl: "<?php echo WS_JQGRID.'ws_ic.process_validation_batch_controller/html_select_options_finance_periode'; ?>",
                            dataInit: function(elem) {
                                $(elem).width(250);  // set the width which you need
                            },
                            // postData : {
                ...
                editurl: '<?php echo WS_JQGRID."ws_ic.process_validation_batch_controller/crud"; ?>',
                caption: "File"
