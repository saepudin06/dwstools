    ...
    var pager_selector = "#grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {label: 'POC Code', name: 'p_poc_code', width: 75, align: 'left'},
                {label: 'Switch Coordinate ID', name: 'p_switch_coordinate_id', width: 130, align: "left", hidden:true},
                {label: 'Organization ID', name: 'p_organization_id', width: 120, align: 'left', hidden:true},
                ...
                {label: 'Coverage Area ID', name: 'p_coverage_area_id', width: 120, align: 'left', hidden:true},
                {label: 'Access Code', name: 'p_access_code', width: 120, align: "left"},
                {label: 'Is Billing Center', name: 'is_billing_center', width: 100, align: 'left'},
                {label: 'Trunk ID', name: 'p_trunk_id', width: 75, align: 'left', hidden:true},
