    ...
    function set_grid(){
        ...
        if (is_set_grid != 'true'){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_ic.param_dws_check_unbill_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                colModel: [
                ...
                editurl: '<?php echo WS_JQGRID."ws_ic.param_dws_check_unbill_controller/crud"; ?>',
                caption: "Check Unbill"
