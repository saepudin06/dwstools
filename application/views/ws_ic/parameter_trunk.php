...
<script>
    ...
    var pager_selector = "#grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            url: '<?php echo WS_JQGRID."ws_ic.parameter_trunk_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
            ...
            onSelectRow: function (rowid) {
                /*do something when selected*/
                  ...
                  jQuery("#grid-table-group").jqGrid('setGridParam', {
                        url: '<?php echo WS_JQGRID."ws_ic.parameter_trunk_controller/readGroup"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."ws_ic.parameter_trunk_controller/read"; ?>',
            caption: "Trunk"
    ...
    var pager_selector = "#grid-pager-group";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            //memanggil controller jqgrid yang ada di controller crud
            editurl: '<?php echo WS_JQGRID."ws_ic.parameter_trunk_controller/readGroup"; ?>',
            caption: "Trunk Group"
