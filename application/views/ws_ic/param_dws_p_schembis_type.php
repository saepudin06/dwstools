    ...
    function set_grid(){
        ...
        if (is_set_grid != 'true'){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_ic.param_dws_p_schembis_type_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                postData: postData,
                colModel: [
                    {label: 'P Schembis Type ID', name: 'p_schembis_type_id', key: true, align: 'center', width: 150, hidden: true, editable: true },
                    ...
                    {label: 'Create By', name: 'create_by', width: 150, align: 'center' },
                ...
                editurl: '<?php echo WS_JQGRID."ws_ic.param_dws_p_schembis_type_controller/crud"; ?>',
