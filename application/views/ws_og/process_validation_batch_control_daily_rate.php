...
<script>
    $("#tab-2").on("click", function(event) {
        ...
        loadContentWithParams("ws_og.process_validation_process_daily_rate", {
...
<script>
    ...
    var edit_options_finance_period = function(p_year_period_id) {
        ...
        var var_url = "<?php echo WS_JQGRID.'ws_og.process_validation_batch_controller/html_select_options_finance_periode'; ?>";
        $.ajax({
          url: var_url ,
          type: "POST",
          dataType: "json",
    ...
    function set_grid() {
        ...
        if (is_set_grid.val() == "false"){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_og.process_validation_batch_daily_rate_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                colModel: [
                    ...
                    {label: 'Year', name: 'p_year_period_id', width: 100, align: "center", editable: true, hidden: true,
                        ...
                        edittype: 'select',
                        editoptions: {
                            dataUrl: "<?php echo WS_JQGRID.'ws_og.process_validation_batch_controller/html_select_options_year_periode'; ?>",
                ...
                editurl: '<?php echo WS_JQGRID."ws_og.process_validation_batch_daily_rate_controller/crud"; ?>',
                caption: "File"
