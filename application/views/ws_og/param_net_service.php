...
<script>
    ...
    var pager_selector = "#grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            url: '<?php echo WS_JQGRID."ws_og.param_net_service_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [
            ...
            onSelectRow: function (rowid) {
                /*do something when selected*/
                  ...
                  jQuery("#grid-table-category").jqGrid('setGridParam', {
                        url: '<?php echo WS_JQGRID."ws_og.param_net_service_controller/readCategory"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."ws_og.param_net_service_controller/read"; ?>',
    ...
    var pager_selector = "#grid-pager-category";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            //memanggil controller jqgrid yang ada di controller crud
            editurl: '<?php echo WS_JQGRID."ws_og.param_net_service_controller/readCategory"; ?>',
