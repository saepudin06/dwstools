...
<script>
    ...
    var pager_selector = "#grid-pager";
        ...
        jQuery(grid_selector).jqGrid({
            url: '<?php echo WS_JQGRID."ws_idd_olo.parameter_trunk_controller/read"; ?>',
            datatype: "json",
            mtype: "POST",
            colModel: [

                {label: 'Trunk ID', key:true, name: 'p_trunk_id', width: 75, hidden:true },
                {label: 'Code', name: 'code', width: 150, align: "left" },
                ...
                {label: 'Em Deg', name: 'em_deg', width: 150, align: 'left'},
                {label: 'Em Min', name: 'em_min', width: 150, align: "left"},
                {label: 'Sl Deg', name: 'sl_deg', width: 150, align: 'left'},
                {label: 'Sl Min', name: 'sl_min', width: 150, align: 'left'},
                ...
                {label: 'Sl Sec',name: 'sl_sec', width: 150, align: "left"},
            ...
            onSelectRow: function (rowid) {
                /*do something when selected*/
                  ...
                  jQuery("#grid-table-group").jqGrid('setGridParam', {
                        url: '<?php echo WS_JQGRID."ws_idd_olo.parameter_trunk_controller/readGroup"; ?>',
            ...
            editurl: '<?php echo WS_JQGRID."ws_idd_olo.parameter_trunk_controller/read"; ?>',
            caption: "Trunk"
    ...
    var pager_selector = "#grid-pager-group";
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {label: 'Access Code', name: 'p_access_code', width: 150, align: 'left'},
                {label: 'Is International', name: 'is_international', width: 150, align: 'left'},
                {label: 'Is Interlink', name: 'is_interlink', width: 150, align: 'left'},
                {label: 'Sl Min', name: 'sl_min', width: 150, align: 'left'},
            ...
            //memanggil controller jqgrid yang ada di controller crud
            editurl: '<?php echo WS_JQGRID."ws_idd_olo.parameter_trunk_controller/readGroup"; ?>',
            caption: "Trunk Group"
