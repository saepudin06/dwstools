...
<script>
    $("#tab-1").on("click", function(event) {
        ...
        loadContentWithParams("ws_idd_olo.process_populate_batch_control", {
...
<script>
    ...
    function set_grid() {
        ...
        if (is_set_grid.val() == "false"){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_idd_olo.process_populate_process_controller/crud"; ?>',
                datatype: "json",
                mtype: "POST",
                ...
                editurl: '<?php echo WS_JQGRID."ws_idd_olo.process_populate_process_controller/crud"; ?>',
    ...
    function set_grid_log() {
        ...
        if (is_set_grid.val() == "false"){
            ...
            jQuery(grid_selector).jqGrid({
                url: '<?php echo WS_JQGRID."ws_idd_olo.process_populate_process_controller/read_log"; ?>',
                datatype: "json",
                mtype: "POST",
                ...
                //memanggil controller jqgrid yang ada di controller crud
                editurl: '<?php echo WS_JQGRID."ws_idd_olo.process_populate_process_controller/read_log"; ?>',
                caption: "Log Proses"
    ...
    function submit_job() {
        Swal.fire({
            ...
            if (result.value) {
                var var_url = "<?php echo WS_JQGRID."ws_idd_olo.process_populate_process_controller/submit_job"; ?>";
                $.ajax({
                  url: var_url ,
                  type: "POST",
                  dataType: "json",
    ...
    function cancel_all_job() {
        Swal.fire({
            ...
            if (result.value) {
                var var_url = "<?php echo WS_JQGRID."ws_idd_olo.process_populate_process_controller/cancel_all_job"; ?>";
                $.ajax({
                  url: var_url ,
                  type: "POST",
                  dataType: "json",
    ...
    function cancel_last_job() {
        Swal.fire({
            ...
            if (result.value) {
                var var_url = "<?php echo WS_JQGRID."ws_idd_olo.process_populate_process_controller/cancel_last_job"; ?>";
                $.ajax({
                  url: var_url ,
                  type: "POST",
                  dataType: "json",
