...
<script>
    ...
    function cancel_all_job() {
        Swal.fire({
            ...
            if (result.value) {
                var var_url = "<?php echo WS_JQGRID."ws_idd_olo.process_validation_process_controller/cancel_all_job"; ?>";
                $.ajax({
                  url: var_url ,
                  type: "POST",
                  dataType: "json",
    ...
    function cancel_last_job() {
        Swal.fire({
            ...
            if (result.value) {
                var var_url = "<?php echo WS_JQGRID."ws_idd_olo.process_validation_process_controller/cancel_last_job"; ?>";
                $.ajax({
                  url: var_url ,
                  type: "POST",
                  dataType: "json",
