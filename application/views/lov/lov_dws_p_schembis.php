                    ...
                    <div class="col-md-9">
                        <div class="input-group col-md-9">
                            ...
                            <span class="input-group-btn">
                                <button class="btn  btn-primary default" type="button" onclick="filter_lov_dws_p_schembis()">Search</button>
                            </span>
                        </div>
                    </div>
                </div>
    ...
    function modal_lov_dws_p_schembis_prepare_table() {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            loadComplete: function (response) {
                ...
                setTimeout(function(){
                    responsive_lov_dws_p_schembis_jqgrid(grid_selector, pager_selector);  
                }, 100);
            },
