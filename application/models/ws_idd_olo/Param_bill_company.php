...
/*
  classname :  Param_bill_company
  Date      : 29-11-2017 02:10:48
 
 */
class Param_bill_company extends Abstract_model {

    public $table           = 'itkp_dws.p_company';
    public $pkey            = 'p_company_id';
    public $alias           = '';

    public $fields          = array(
								'p_company_id'=> array (   'pkey' => true,'type' => 'int' , 'nullable' => false , 'unique' => false , 'display' =>  'P Bill Component Id' ),
                                'code'=> array (  'type' => 'str' , 'nullable' => false , 'unique' => false , 'display' =>  'Code' ),
                                'is_owner'=> array (  'type' => 'str' , 'nullable' => false , 'unique' => false , 'display' =>  'Is Owner' ),
                                'payment_priority'=> array (  'type' => 'str' , 'nullable' => false , 'unique' => false , 'display' =>  'Payment Priority' ),
    ...
    public $selectClause    = "*";
    public $fromClause      = "itkp_dws.p_company";
...
/* End of file Param_bill_company.php */