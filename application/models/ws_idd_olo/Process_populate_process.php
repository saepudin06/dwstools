...
/**
 * Process_populate_process Model
 *
 */
class Process_populate_process extends Abstract_model {
    ...
    function validate() {
        ...
        $this->record['input_file_name'] = "IDD_OLO_".$res_code['code']."_".$periode['p_finance_period_id'];
        $this->record['parameters'] = $periode['p_finance_period_id'];//$periode['finance_period_code'];
