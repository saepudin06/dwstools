 ...
 *
 */
class Process_validation_batch_rate extends Abstract_model {
    ...
    function validate() {
        ...
        $this->db->set('input_file_name', "VALIDATIONRATE_IC_".$periode['finance_period_code']); //IC_POPULATEDATAIC_2019-JAN
