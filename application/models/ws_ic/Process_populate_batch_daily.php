 ...
 *
 */
class Process_populate_batch_daily extends Abstract_model {
    ...
    function validate() {
        ...
        $input_data_class_id = 13;
        $periode = $this->db->where('p_finance_period_id', $this->record['p_finance_period_id'])->get('p_finance_period')->row_array();
        
        $this->db->set('input_file_name', "POPULATEDAILY_IC_".$periode['finance_period_code']); //IC_POPULATEDATAIC_2019-JAN
