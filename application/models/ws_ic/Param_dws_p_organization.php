...
/*
  classname :  Param_dws_p_organization
  Date      : 29-11-2017 02:10:48
 
 */
class Param_dws_p_organization extends Abstract_model {

    public $table           = 'ic_dws.dws_p_organization';
    public $pkey            = 'p_organization_id';
    public $alias           = '';

    public $fields          = array(
                                'p_organization_id' => array ( 'pkey' => true, 'type' => 'int', 'nullable' => false, 'unique' => false, 'display' =>  'P Organization Id' ),
                                'p_company_id' => array ( 'type' => 'str' , 'nullable' => false, 'unique' => false , 'display' =>  'Company ID' ),
    ...
    public $selectClause    = "*";
    public $fromClause      = "ic_dws.dws_p_organization";
...
/* End of file Param_dws_p_organization.php */