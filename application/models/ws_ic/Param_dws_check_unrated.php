...
/*
  classname :  Param_dws_check_unrated
  Date      : 29-11-2017 02:10:48
 
 */
class Param_dws_check_unrated extends Abstract_model {

    public $table           = 'ic_dws.p_check_unrated';
    public $pkey            = 'p_check_unrated_id';
    public $alias           = '';

    public $fields          = array(
								'p_check_unrated_id'=> array (   'pkey' => true,'type' => 'int' , 'nullable' => false , 'unique' => false , 'display' =>  'P Check Unrated Id' ),
                                ...
                                'term_poc'=> array (  'type' => 'str' , 'nullable' => false , 'unique' => false , 'display' =>  'Term POC' ),
    ...
    public $selectClause    = "*";
    public $fromClause      = "ic_dws.p_check_unrated";
...
/* End of file Param_dws_check_unrated.php */