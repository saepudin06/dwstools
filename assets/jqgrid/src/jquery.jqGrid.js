	...
	styleUI : {
		...
		Bootstrap : {
			...
			base : {
				...
				pgButtonBox : "",
				icon_first : "fal fa-step-backward",
				icon_prev : "fal fa-backward",
				icon_next: "fal fa-forward",
				icon_end: "fal fa-step-forward",
				icon_asc : "glyphicon-triangle-top",
				icon_desc : "glyphicon-triangle-bottom",
				icon_caption_open : "fal fa-chevron-up",
				icon_caption_close : "fal fa-chevron-down"
			},
			modal : {
				modal : "modal-content",
				header : "modal-header",
			...
			formedit : {
				inputClass : "form-control",
				icon_prev : "fal fa-chevron-left",
				icon_next : "fal fa-chevron-right",
				icon_save : "fal fa-check",
				icon_close : "fal fa-times",
				icon_del : "fal fa-trash-alt",
				icon_cancel : "fal fa-times"
			},
			navigator : {
				icon_edit_nav : "glyphicon-edit",
				icon_add_nav : "glyphicon-plus",
